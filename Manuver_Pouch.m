function help = Manuver_Pouch(mat_R_T_M, mat_R_T_G)
    % Manuver Cans
    ...
    strategy = 'topdown';
    ret = pickpouch(strategy, mat_R_T_M);  % Can have optional starting pose for ctraj like: ret = pick(strategy, mat_R_T_M,mat_R_T_G);
